...
5. **spaicel font** ℱℴ𝓃𝓉 𝒞𝒽𝒶𝓃ℊℯ𝓇(Cursive👉don't use normally),𝔽𝕠𝕟𝕥 ℂ𝕙𝕒𝕟𝕘𝕖𝕣(Double Struck),𝓕𝓸𝓷𝓽 𝓒𝓱𝓪𝓷𝓰𝓮𝓻(Bold Cursive),𝙵𝚘𝚗𝚝 𝙲𝚑𝚊𝚗𝚐𝚎𝚛(Monospace),Ⓕⓞⓝⓣ Ⓒⓗⓐⓝⓖⓔⓡ(Bubbles),🅕🅞🅝🅣 🅒🅗🅐🅝🅖🅔🅡(Dark Bubbles),🄵🄾🄽🅃 🄲🄷🄰🄽🄶🄴🅁((Squares),🅵🅾🅽🆃 🅲🅷🅰🅽🅶🅴🆁(dark Squares),𝗧𝗲𝘅𝘁(bold),𝑇𝑒𝑥𝑡(italic),𝙏𝙚𝙭𝙩(italic bold),𝙏𝙚𝙭𝙩(Sans-Serif Bold Italic)
