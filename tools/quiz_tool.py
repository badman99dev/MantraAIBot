import logging
import asyncio
from bot import THREAD_LOCALS # bot.py se shared data import karna
...
def send_quiz_poll(question: str, options: list, correct_option_index: int, explanation: str) -> str:
    ...
    """
    try:
        # bot.py se context aur event loop ko access karna
        context = THREAD_LOCALS.context
        loop = THREAD_LOCALS.loop
        chat_id = context._chat_id
        
        # Async function ko main event loop par safely schedule karna
